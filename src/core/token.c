...
static const TokenDescriptor TOKEN_TABLE[] = {
    ...
    [TOKEN_USE] = {"use", 0},
    [TOKEN_IMPL] = {"impl", 0},
    [TOKEN_BOOL] = {"bool", TKF_TYPE_KEYWORD},
    [TOKEN_I8] = {"i8", TKF_TYPE_KEYWORD},
    [TOKEN_I16] = {"i16", TKF_TYPE_KEYWORD},
    [TOKEN_I32] = {"i32", TKF_TYPE_KEYWORD},
    [TOKEN_I64] = {"i64", TKF_TYPE_KEYWORD},
    [TOKEN_I128] = {"i128", TKF_TYPE_KEYWORD},
    [TOKEN_U8] = {"u8", TKF_TYPE_KEYWORD},
    [TOKEN_U16] = {"u16", TKF_TYPE_KEYWORD},
    [TOKEN_U32] = {"u32", TKF_TYPE_KEYWORD},
    [TOKEN_U64] = {"u64", TKF_TYPE_KEYWORD},
    [TOKEN_U128] = {"u128", TKF_TYPE_KEYWORD},
    [TOKEN_ISIZE] = {"isize", TKF_TYPE_KEYWORD},
    [TOKEN_USIZE] = {"usize", TKF_TYPE_KEYWORD},
